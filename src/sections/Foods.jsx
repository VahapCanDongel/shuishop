...
export default function Foods() {
    ...
    return (
        <div className="my-20 flex justify-between flex-col items-center w-[80%]  sm:flex-col gap-4 sm:w-full transition" id="foods">
            ...
            <CategoryNav />
            {page === "noodle" && (
                <div className='overflow-scroll grid grid-cols-2 gap-20 h-[400px] flex-shrink-0 rounded-md w-3/4 sm:overflow-scroll sm:gap-4 sm:w-full sm:flex sm:flex-col sm:justify-center sm:items-center'>
                    {
