    ...
    return (
        <div className="flex justify-evenly items-center w-[80%] my-20 gap-6 sm:w-full sm:flex-col" id="home">
            <div className="relative">
                ...
                <div className="w-[800px] h-[500px] bg-green-400 absolute z-0 top-0 left-0 rotate-12 ml-[-40px] sm:w-[400px] sm:ml-[-20px]"></div>
            </div>



            <img src="https://www.maisushi.com/wp-content/uploads/2019/11/NigiriRollClassicPlatter_Large_IMG_2140.png" className="w-[600px] h-[600px] rotate-45 sm:w-[300px] sm:h-[300px]" />
